	...
	<form action="{{ route('store_wisher') }}" method="post">
		...
		<section class="flex flex-wrap justify-between max-w-lg mx-auto px-8">
			<section class="w-64">
				...
				<input type="text" name="sender_name" id="sender_name" class="inputfield">
				<label for="sender_email" class="text-left block mt-8">{{ __('app.email-sender') }}</label>
				<input type="text" name="sender_email" id="sender_email" class="inputfield">
			</section>
			<section class="w-64">
				...
				<input type="text" name="recipient_email" id="recipient_email" class="inputfield">
			</section>
		</section>
